...
The agent picks the right shell automatically.
...
Configured by default: npm → npmmirror.com, pip → aliyun mirror, Git proxy, UTF-8. Use `-SkipMirrors` to skip.
